...
/**
 * The real marks for the places people can find me.
 *
 * lucide only ships outline stand-ins for brands — and nothing at all for X —
 * so these are the logos themselves. They are filled with `currentColor` and
...
function Mark({d, viewBox = "0 0 24 24", ...props}: IconProps & {d: string}) {
    return (
        <svg
